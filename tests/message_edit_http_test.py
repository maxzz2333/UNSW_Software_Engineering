...
def test_message_edit_token_invalid():
    ...
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': 1, 'message_id': message_id, 'message': over_1000_characters})
    assert message_edit_response.status_code == ACCESS_ERROR_CODE
...
def test_message_edit_authuser_invalid():
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': generate_jwt(user1_id, 10), 'message_id': message_id, 'message': over_1000_characters})
    assert message_edit_response.status_code == ACCESS_ERROR_CODE

#Occurrences of InputError  length of message is over 1000 characters
def test_message_edit_message_over_1000():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user2_token, 'message_id': message_id, 'message': over_1000_characters})
    assert message_edit_response.status_code == INPUT_ERROR_CODE
...
def test_message_edit_message_invalid():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user2_token, 'message_id': -1, 'message': equal_1_characters})
    assert message_edit_response.status_code == INPUT_ERROR_CODE
...
def test_message_edit_message_valid_user_not_authorised_and_user_not_channel_owner():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user3_token, 'message_id': message_id, 'message': equal_1_characters})
    assert message_edit_response.status_code == ACCESS_ERROR_CODE

#Occurrences of AccessError the message was not sent by the authorised user making this request and the authorised user not has owner permissions in the DM
def test_message_edit_message_valid_user_not_authorised_and_user_not_dm_owner_1():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user_3['token'], 'message_id': message_id, 'message': equal_1_characters})
    assert message_edit_response.status_code == ACCESS_ERROR_CODE

def test_message_edit_message_valid_user_not_authorised_and_user_not_dm_owner_2():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#Run successfully new message is not an empty
def test_message_editd_message_vaild_user_not_authorised_but_user_is_channel_owner():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user1_token, 'message_id': message_id, 'message': less_1000_over_1_characters})
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user2_token, 'message_id': message_id, 'message': less_1000_over_1_characters})
    assert message_edit_response.status_code == SUCCESS_CODE


def test_message_editd_message_vaild_user_not_authorised_but_user_is_dm_owner():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user_1['token'], 'message_id': message_id, 'message': equal_1_characters})
    assert message_edit_response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user_2['token'], 'message_id': message_id, 'message': equal_1_characters})
    assert message_edit_response.status_code == SUCCESS_CODE 

#Run successfully new message is not an empty
def test_message_edit_message_vaild_user_is_authorised_but_user_not_channel_owner():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
def test_message_edit_message_vaild_user_is_authorised_but_user_not_dm_owner():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#Run successfully new message is an empty
def test_message_edit_message_vaild_user_is_authorised_but_user_not_channel_owner_message_is_empty():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user2_token, 'message_id': message_id, 'message': less_1_characters})
    assert message_edit_response.status_code == SUCCESS_CODE

def test_message_editd_message_vaild_user_not_authorised_but_user_is_channel_owner_message_is_empty():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user1_token, 'message_id': message_id, 'message': less_1_characters})
    assert message_edit_response.status_code == SUCCESS_CODE
...
def test_message_edit_message_vaild_user_is_authorised_but_user_not_dm_owner_message_is_empty():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user_2['token'], 'message_id': message_id, 'message': less_1_characters})
    assert message_edit_response.status_code == SUCCESS_CODE

def test_message_editd_message_vaild_user_not_authorised_but_user_is_dm_owner_message_is_empty():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #eid message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user_1['token'], 'message_id': message_id, 'message': less_1_characters})
    assert message_edit_response.status_code == SUCCESS_CODE
...
#Run successfully 
def test_message_edit_message__user_is_authorised_send_empty_messagea_to_channel_1():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#Run successfully 
def test_message_edit_message__user_is_authorised_send_not_empty_messagea_to_channel_1():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #send message to channel
    message_send_response = requests.post(f"{config.url}message/send/v1",json={'token': user2_token, 'channel_id': channel_id, 'message': "i love you"})
    assert message_send_response.status_code == SUCCESS_CODE
    messages_send_data = message_send_response.json()
    assert messages_send_data['message_id'] == 1
    message_id = messages_send_data['message_id']
    ...
    #edit message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user2_token, 'message_id': message_id, 'message': "i do not like you"})
    assert message_edit_response.status_code == SUCCESS_CODE 
    ...
    assert messages_0['message'] == "i do not like you"
    assert len(channel_messages_data['messages']) == 1
    assert channel_messages_data['start'] == 0
    assert channel_messages_data['end'] == -1

def test_message_edit_message__user_is_authorised_send_not_empty_messagea_to_channel_2():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#Run successfully 
def test_message_edit_message__user_is_authorised_send_empty_messagea_to_dm_1():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#Run successfully 
def test_message_edit_message__user_is_authorised_send_not_empty_messagea_to_dm_1():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #edit message to channel or dm
    message_edit_response = requests.put(f"{config.url}message/edit/v1",json={'token': user_2['token'], 'message_id': message_id, 'message': "l love you "})
    assert message_edit_response.status_code == SUCCESS_CODE 
    ...
    assert messages_0['message'] == "l love you "
    assert len(dm_messages_data['messages']) == 1
    assert dm_messages_data['start'] == 0
    assert dm_messages_data['end'] == -1


def test_message_edit_message__user_is_authorised_send_not_empty_messagea_to_dm_2():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
