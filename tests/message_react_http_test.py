...
InputError when any of:
        message_id is not a valid message within a channel or DM that the authorised user has joinedmessage_id 
        

        react_id is not a valid react ID - currently, the only valid react ID the frontend has is 1react_id 
        
        the message already contains a react with ID react_id from the authorised user
        
'''
def test_message_react_token_invalid():
    #clear data_store
    ...
    message_ract_response = requests.post(f"{config.url}message/react/v1",json={'token': 1, 'message_id': message_id, 'react_id':1})
    assert message_ract_response.status_code == ACCESS_ERROR_CODE

def test_message_ract_authuser_invalid():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #ract message in channel
    message_ract_response = requests.post(f"{config.url}message/react/v1",json={'token': generate_jwt(user1_id, 10), 'message_id': message_id, 'react_id':1})
    assert message_ract_response.status_code == ACCESS_ERROR_CODE

#Occurrences of InputError message_id is not a valid message
def test_message_ract_message_invalid():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #ract message in channel
    message_ract_response = requests.post(f"{config.url}message/react/v1",json={'token': user1_token, 'message_id': -1, 'react_id':1})
    assert message_ract_response.status_code == INPUT_ERROR_CODE

#Occurrences of InputError not a valid message within a channel or DM that the authorised user has join
def test_message_ract_message_invalid_user_not_join_channel():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#Occurrences of InputError not a valid message within a channel or DM that the authorised user has join
def test_message_ract_message_invalid_user_not_join_DM():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #ract message in dm
    message_ract_response = requests.post(f"{config.url}message/react/v1",json={'token':user_3['token'], 'message_id': message_id, 'react_id':1})
    assert message_ract_response.status_code == INPUT_ERROR_CODE 
...
def test_message_ract_ract_id_invalid_in_channel():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#Occurrences of InputError react_id is not a valid react ID
def test_message_ract_ract_id_invalid_in_DM():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #ract message in dm
    message_ract_response = requests.post(f"{config.url}message/react/v1",json={'token':user_2['token'], 'message_id': message_id, 'react_id':-1})
    assert message_ract_response.status_code == INPUT_ERROR_CODE 
...
#Occurrences of InputError message already contains a react with ID react_id from the authorised user
def test_message_ract_message_already_react_by_user_in_channel():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
def test_message_ract_message_already_react_by_user_in_DM():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#run successful 
def test_message_ract_ract_by_1user_in_channel():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
def test_message_ract_ract_by_1user_in_channel_2():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
def test_message_ract_ract_by_2user_in_channel():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #ract message in channel
    message_ract_response = requests.post(f"{config.url}message/react/v1",json={'token': user1_token, 'message_id': message_id, 'react_id':1})
    assert message_ract_response.status_code == SUCCESS_CODE
...
def test_message_ract_ract_by_3user_in_channel():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
#run successful 
def test_message_ract_ract_by_1user_in_DM():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
    ...
    #ract message in dm
    message_ract_response = requests.post(f"{config.url}message/react/v1",json={'token':user_1['token'], 'message_id': message_id, 'react_id':1})
    assert message_ract_response.status_code == SUCCESS_CODE 
...
def test_message_ract_ract_by_1user_in_DM_2():
    #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
def test_message_ract_ract_by_2user_in_DM():
     #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
...
def test_message_ract_ract_by_3user_in_DM():
     #clear data_store
    response = requests.delete(f"{config.url}clear/v1")
    assert response.status_code == SUCCESS_CODE
